...
import type { ComponentIdentifier, Entity } from '@orion-ecs/plugin-api';
...
> {
  ...
  evaluate(name: string, entity: Entity, args: Record<string, unknown>, context: PredicateContext): boolean {
